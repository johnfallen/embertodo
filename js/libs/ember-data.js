  ...
  function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
    ...
    __exports__["default"] = function setupActiveModelAdapter(container, application){
      ...
      proxy.registerDeprecations([
        { deprecated: 'serializer:_ams',  valid: 'serializer:-active-models' },
        { deprecated: 'adapter:_ams',     valid: 'adapter:-active-models' }
      ]);

      container.register('serializer:-active-models', ActiveModelSerializer);
      container.register('adapter:-active-models', ActiveModelAdapter);
    };
  });
  ...
  function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
    ...
    */
    ...
    /**
      ...
      For example, if you have a `Person` models:
      ...
      Let's imagine that `Occupation` is just another models:
    ...
    **/
    ...
    var ActiveModelAdapter = RESTAdapter.extend({
      defaultSerializer: '-active-models',
      /**
    ...
    */
    var ActiveModelSerializer = RESTSerializer.extend({
      ...
      */
      ...
      /**
        Serializes a polymorphic type as a fully capitalized models name.
    ...
    __exports__["default"] = Adapter.extend({
      ...
      */
      find: function(store, type, id) {
        ...
        Ember.assert("Unable to find fixtures for models type "+type.toString() +". If you're defining your fixtures using `Model.FIXTURES = ...`, please change it to `Model.reopenClass({ FIXTURES: ... })`.", fixtures);
      ...
      */
      findMany: function(store, type, ids) {
        ...
        Ember.assert("Unable to find fixtures for models type "+type.toString(), fixtures);
    ...
    __exports__["default"] = Adapter.extend({
      ...
      */
      ...
      /**
        ...
        saved via the `save` method on a models record instance.
      ...
      */
      ...
      /**
        ...
        via the `save` method on a models record instance.
...
define("ember-data/serializers/embedded_records_mixin",
  ...
  function(__exports__) {
    ...
    /**
      ...
      then define and configure embedded (models) relationships.
      ...
      defining a models while working with the ActiveModelSerializer.  Nevertheless,
      ...
      Embedded records must have a models defined to be extracted and serialized. Note that
      when defining any relationships on your models such as `belongsTo` and `hasMany`, you
      should not both specify `async:true` and also indicate through the serializer's
      `attrs` attribute that the related models should be embedded.  If a models is
      declared embedded, then do not use `async:true`.

      To successfully extract and serialize embedded records the models relationships
      must be setup correcty See the
      [defining relationships](/guides/models/defining-models/#toc_defining-relationships)
      section of the **Defining Models** guide page.

      Records without an `id` property are not considered embedded records, models
    ...
    var EmbeddedRecordsMixin = Ember.Mixin.create({
      ...
      **/
      ...
      /**
        ...
        This example of an author models belongs to a post models:
        ...
        Use a custom (type) serializer for the post models to configure embedded author
      ...
      */
      ...
      /**
        ...
        This example of a post models has many comments:
        ...
        Use a custom (type) serializer for the post models to configure embedded comments
    ...
    __exports__["default"] = Ember.Object.extend({
      ...
      */
      ...
      /**
        ...
        For example, consider this models:
      ...
      */
      ...
      /**
       ...
       attribute name in your models to a key in your JSON.
  ...
  function(__dependency1__, __dependency2__, __exports__) {
    ...
    */
    ...
    /**
      ...
      name in your models to a key in your JSON.
    ...
    var RESTSerializer = JSONSerializer.extend({
      ...
      */
      ...
      /**
        ...
        into a typeKey that it can use to look up the appropriate models for
        that part of the payload. By default the typeKey for a models is its
        ...
        In order for Ember Data to know that the models corresponding to
        ...
        @method typeForRoot
        @param {String} key
        @return {String} the models's typeKey
      */
      ...
      */
      ...
      /**
        ...
        By default the REST Serializer sends the typeKey of a models, which is a camelized
        version of the name.
      ...
      */
      ...
      /**
        ...
        the attribute and value from the models's camelcased models name.
    ...
    Ember.runInDebug(function(){
      RESTSerializer.reopen({
        warnMessageNoModelForKey: function(prop, typeKey){
          return 'Encountered "' + prop + '" in payload, but no models was found for models name "' + typeKey + '" (resolved models name using ' + this.constructor.toString() + '.typeForRoot("' + prop + '"))';
        }
      });
    });
  ...
  function(__exports__) {
    ...
    */
    ...
    /**
      ...
      keys are the invalid models properties, and whose values are the
    ...
    */
    ...
    var Adapter = Ember.Object.extend({
      ...
      /**
        ...
        a models specific serializer (i.e. `PostSerializer`) or the
...
define("ember-data/system/debug/debug_adapter",
  ["ember-data/system/models","exports"],
  function(__dependency1__, __exports__) {
    "use strict";
    /**
      @module ember-data
...
define("ember-data/system/debug/debug_info",
  ...
  function(__dependency1__, __exports__) {
    ...
    Model.reopen({
      ...
      /**
        Provides info about the models for debugging purposes
...
define("ember-data/system/models",
  ["ember-data/system/models/models","ember-data/system/models/attributes","ember-data/system/models/states","ember-data/system/models/errors","exports"],
  function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
    "use strict";
    /**
      @module ember-data
...
define("ember-data/system/models/attributes",
  ["ember-data/system/models/models","ember-data/system/map","exports"],
  function(__dependency1__, __dependency2__, __exports__) {
    "use strict";
    var Model = __dependency1__["default"];
    ...
    */
    Model.reopenClass({
      /**
        A map whose keys are the attributes of the models (properties
      ...
      */
      attributes: Ember.computed(function() {
        ...
        this.eachComputedProperty(function(name, meta) {
          if (meta.isAttribute) {
            Ember.assert("You may not set `id` as an attribute on your models. Please remove any lines that look like: `id: DS.attr('<type>')` from " + this.toString(), name !== 'id');
      ...
      */
      ...
      /**
        Iterates through the attributes of the models, calling the passed function on each
        attribute.
      ...
      */
      ...
      /**
        Iterates through the transformedAttributes of the models, calling
    ...
    __exports__["default"] = function attr(type, options) {
      ...
      return Ember.computed('data', function(key, value) {
        if (arguments.length > 1) {
          Ember.assert("You may not set `id` as an attribute on your models. Please remove any lines that look like: `id: DS.attr('<type>')` from " + this.constructor.toString(), key !== 'id');
...
define("ember-data/system/models/errors",
  ...
  function(__dependency1__, __exports__) {
    ...
    */
    ...
    /**
      ...
      For Example, if you had an `User` models that looked like this:
...
define("ember-data/system/models/models",
  ["ember-data/system/models/states","ember-data/system/models/errors","ember-data/system/promise_proxies","ember-data/system/relationships/relationship","exports"],
  function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
    "use strict";
    ...
    */
    ...
    /**
      ...
      The models class that all Ember Data records descend from.
    ...
    */
    var Model = Ember.Object.extend(Ember.Evented, {
      ...
      */
      ...
      /**
        ...
        ```javascript
        var record = store.createRecord('models');
        record.get('isLoaded'); // true

        store.find('models', 1).then(function(models) {
          models.get('isLoaded'); // true
        });
        ```
      ...
      */
      ...
      /**
        ...
        store.find('models', 1).then(function(models) {
          models.get('isDirty'); // false
          models.set('foo', 'some value');
          models.get('isDirty'); // true
        });
        ```
      ...
      */
      ...
      /**
        ...
        record.save().then(function(models) {
          models.get('isNew'); // false
        });
        ```
      ...
      */
      ...
      /**
        ...
        attributes for a models it is an error to declare an id
        attribute.
      ...
      */
      ...
      /**
        ...
        App.ModelDeleteRoute = Ember.Route.extend({
          actions: {
            softDelete: function() {
              this.controller.get('models').deleteRecord();
            },
            confirm: function() {
              this.controller.get('models').save();
            },
            undo: function() {
              this.controller.get('models').rollback();
            }
          }
        });
        ```
        ...
        App.ModelDeleteRoute = Ember.Route.extend({
          actions: {
            delete: function() {
              ...
              controller.get('models').destroyRecord().then(function() {
                controller.transitionToRoute('models.index');
              });
            }
          }
        });
      ...
      */
      ...
      /**
        If the models `isDirty` this function will discard any unsaved
        changes
      ...
      */
      ...
      /**
        ...
        App.ModelViewRoute = Ember.Route.extend({
          actions: {
            reload: function() {
              this.controller.get('models').reload();
            }
          }
        });
        ```
    ...
    Model.reopenClass({
      ...
      */
      create: function() {
        throw new Ember.Error("You should not call `create` on a models. Instead, call `store.createRecord` with the attributes you would like to set.");
      }
    });

    __exports__["default"] = Model;
  });
define("ember-data/system/models/states",
  ["exports"],
  function(__exports__) {
    "use strict";
    /**
  ...
  function(__dependency1__, __exports__) {
    ...
    */
    ...
    __exports__["default"] = Ember.ArrayProxy.extend(Ember.Evented, {
      /**
        The models type contained by this record array.
  ...
  function(__dependency1__, __exports__) {
    ...
    /**
      ...
      - `inverse`: A string used to identify the inverse property on a
        related models in a One-To-Many relationship. See [Explicit Inverses](#toc_explicit-inverses)
      ...
      @method belongsTo
      @for DS
      @param {String or DS.Model} type the models type of the relationship
      @param {Object} options a hash of options
    ...
    */
    function belongsTo(type, options) {
      if (typeof type === 'object') {
        ...
        Ember.assert("The first argument to DS.belongsTo must be a string representing a models type key, e.g. use DS.belongsTo('person') to define a relation to the App.Person models", !!type && (typeof type === 'string' || Model.detect(type)));
      }
...
define("ember-data/system/relationships/ext",
  ["ember-data/system/relationship-meta","ember-data/system/models","ember-data/system/map"],
    ...
    */
    ...
    /*
      ...
      **These properties are effectively sealed once called for the first time.**
      To avoid repeatedly doing expensive iteration over a models's fields, these
      values are computed once and then cached for the remainder of the runtime of
      your application.

      If your application needs to modify a class after its initial definition
      (for example, using `reopen()` to add additional attributes), make sure you
      do it before using your models with the store, which uses these properties
      extensively.
    */
    ...
    Model.reopenClass({
      ...
      /**
        For a given relationship name, returns the models type of the relationship.

        For example, if you define a models like this:
      ...
      */
      ...
      _findInverseFor: function(name) {
        ...
        if (options.inverse) {
          ...
          Ember.assert("We found no inverse relationships by the name of '" + inverseName + "' on the '" + inverseType.typeKey +
            "' models. This is most likely due to a missing attribute on your models definition.", !Ember.isNone(inverse));
      ...
      /**
        The models's relationships as a map, keyed on the type of the
        relationship. The value of each entry is an array containing a descriptor
        for each relationship with that type, describing the name of the relationship
        as well as the type.

        For example, given the following models definition:
      ...
      */
      ...
      /**
        A hash containing lists of the models's relationships, grouped
        by the relationship kind. For example, given a models with this
        definition:
      ...
      */
      ...
      /**
        An array of types directly related to a models. Each type will be
        included once, regardless of the number of relationships it has with
        the models.

        For example, given a models with this definition:
      ...
      */
      ...
      /**
        A map whose keys are the relationships of a models and whose values are
        relationship descriptors.

        For example, given a models with this
        definition:
      ...
      */
      ...
      /**
        A map whose keys are the fields of the models and whose values are strings
        describing the kind of the field. A models's fields are the union of all of its
      ...
      */
      ...
      /**
        Given a callback, iterates over each of the relationships in the models,
      ...
      */
      ...
      /**
        Given a callback, iterates over each of the types related to a models,
  ...
  function(__dependency1__, __exports__) {
    ...
    */
    ...
    /**
      ...
      - `async`: A boolean value used to explicitly declare this to be an async relationship.
      - `inverse`: A string used to identify the inverse property on a related models.
      ...
      relationship to that models.

      However, sometimes you may have multiple `belongsTo`/`hasManys` for the
      same type. You can specify which property on the related models is
  ...
  function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
    ...
    */
    Store = Ember.Object.extend({
      ...
      */
      ...
      /**
        ...
        this method is the models's name as a string.
        ...
        If you have access to the post models you can also pass the models itself:
      ...
      */
      ...
      /**
        Returns a models class for a particular key. Used by
      ...
      */
      modelFor: function(key) {
        ...
        if (typeof key === 'string') {
          ...
          if (!factory) {
            throw new Ember.Error("No models was found for '" + key + "'");
          }
      ...
      /**
        ...
        * The names of attributes are the ones you used in
          your models's `DS.attr`s.
        * Your relationships must be:
          * represented as IDs or Arrays of IDs
          * represented as models instances
      ...
      */
      ...
      /**
        ...
        Alternatively, `pushPayload` will accept a models type which
        will determine which serializer will process the payload.
        However, the serializer itself (processing this data via
        `normalizePayload`) will not know which models it is
        deserializing.
        ...
        @method pushPayload
        @param {String} type Optionally, a models used to determine which serializer will be used
        @param {Object} payload
      */
      ...
      /**
        ...
        @method normalize
        @param {String} type The name of the models type for this payload
        @param {Object} payload
        @return {Object} The normalized payload
      */
      ...
      */
      buildRecord: function(type, id, data) {
        ...
        Ember.assert("`" + Ember.inspect(type)+ "` does not appear to be an ember-data models", (typeof type._create === 'function') );
    ...
    function deserializeRecordId(store, data, key, relationship, id) {
      if (!Model) { Model = requireModule("ember-data/system/models")["Model"]; }
...
define("ember-data/transforms/base",
  ...
  function(__exports__) {
    "use strict";
    /**
      The `DS.Transform` class is used to serialize and deserialize models
